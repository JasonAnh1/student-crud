...
class StudentResourceIT {
    ...
    void putExistingStudent() throws Exception {
        ...
        updatedStudent.name(UPDATED_NAME).code(UPDATED_CODE).phone(UPDATED_PHONE).birthday(UPDATED_BIRTHDAY).address(UPDATED_ADDRESS);
    ...
    void partialUpdateStudentWithPatch() throws Exception {
        ...
        partialUpdatedStudent.name(UPDATED_NAME).phone(UPDATED_PHONE).birthday(UPDATED_BIRTHDAY);
